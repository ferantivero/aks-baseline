...
1. Identify your jump box image.
   ...
   RESOURCEID_IMAGE_JUMPBOX=$(az deployment group show -g rg-bu0001a0005-$LOCATION_AKS_BASELINE -n CreateJumpBoxImageTemplate --query 'properties.outputs.distributedImageResourceId.value' -o tsv)
